...
// RUN: %clang_cc1 -triple x86_64-unknown-linux-gnu -std=c++11 -fdrop-align-attr -emit-llvm -o - %s | FileCheck %s --check-prefixes=CHECK-ALIGN
...
// CHECK-NEXT:    [[B:%.*]] = alloca [[STRUCT_B:%.*]], align 1
// CHECK-NEXT:    call void @_ZN1AC1Ev(ptr noundef nonnull align 1 dereferenceable(1) [[A]])
// CHECK-ALIGN:    call void @_ZN1AC1Ev(ptr noundef nonnull dereferenceable(1) [[A:.*]])
