...
; RUN: opt < %s -passes=memcpyopt,dse -zero-uninit-loads -S -verify-memoryssa | FileCheck %s --check-prefixes=CHECK-ZERO
...
; CHECK-NEXT:    ret void
;
; CHECK-ZERO-LABEL: @test9(
; CHECK-ZERO-NEXT:  entry:
; CHECK-ZERO-NEXT:    [[B:%.*]] = alloca [[STRUCT_BIG:%.*]], align 4
; CHECK-ZERO-NEXT:    [[TMP:%.*]] = alloca [[STRUCT_BIG]], align 4
; CHECK-ZERO-NEXT:    call void @f1(ptr sret([[STRUCT_BIG]]) [[TMP]])
; CHECK-ZERO-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[B]], ptr align 4 [[TMP]], i64 200, i1 false)
; CHECK-ZERO-NEXT:    call void @f2(ptr [[B]])
